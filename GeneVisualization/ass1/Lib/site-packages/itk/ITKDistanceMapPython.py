...
if version_info >= (3, 0, 0):
    new_instancemethod = lambda func, inst, cls: _ITKDistanceMapPython.SWIG_PyInstanceMethod_New(func)
else:
...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_ITKDistanceMapPython', [dirname(__file__)])
        except ImportError:
            import _ITKDistanceMapPython
            return _ITKDistanceMapPython
        if fp is not None:
            try:
                _mod = imp.load_module('_ITKDistanceMapPython', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _ITKDistanceMapPython = swig_import_helper()
