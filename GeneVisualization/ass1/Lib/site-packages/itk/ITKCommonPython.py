...
if version_info >= (3, 0, 0):
    new_instancemethod = lambda func, inst, cls: _ITKCommonPython.SWIG_PyInstanceMethod_New(func)
else:
...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_ITKCommonPython', [dirname(__file__)])
        except ImportError:
            import _ITKCommonPython
            return _ITKCommonPython
        if fp is not None:
            try:
