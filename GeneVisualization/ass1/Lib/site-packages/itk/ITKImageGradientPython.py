...
if version_info >= (3, 0, 0):
    new_instancemethod = lambda func, inst, cls: _ITKImageGradientPython.SWIG_PyInstanceMethod_New(func)
else:
...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_ITKImageGradientPython', [dirname(__file__)])
        except ImportError:
            import _ITKImageGradientPython
            return _ITKImageGradientPython
        if fp is not None:
            try:
                _mod = imp.load_module('_ITKImageGradientPython', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _ITKImageGradientPython = swig_import_helper()
