...
class vnl_matrix_refD(vnl_matrixPython.vnl_matrixD):
    ...
    def __init__(self, *args):
        """
        __init__(vnl_matrix_refD self, unsigned int m, unsigned int n, double * datablck) -> vnl_matrix_refD
...
class vnl_matrix_refF(vnl_matrixPython.vnl_matrixF):
    ...
    def __init__(self, *args):
        """
        __init__(vnl_matrix_refF self, unsigned int m, unsigned int n, float * datablck) -> vnl_matrix_refF
