...
snake_case_functions = ('discrete_gaussian_image_filter', 'mean_image_filter', 'recursive_gaussian_image_filter', 'binomial_blur_image_filter', 'smoothing_recursive_gaussian_image_filter', 'median_image_filter', )
