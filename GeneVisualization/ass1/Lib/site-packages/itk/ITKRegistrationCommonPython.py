...
if version_info >= (3, 0, 0):
    new_instancemethod = lambda func, inst, cls: _ITKRegistrationCommonPython.SWIG_PyInstanceMethod_New(func)
else:
...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_ITKRegistrationCommonPython', [dirname(__file__)])
        except ImportError:
            import _ITKRegistrationCommonPython
            return _ITKRegistrationCommonPython
        if fp is not None:
            try:
                _mod = imp.load_module('_ITKRegistrationCommonPython', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _ITKRegistrationCommonPython = swig_import_helper()
...
from itkBlockMatchingImageFilterPython import *
...
from itkLandmarkBasedTransformInitializerPython import *
...
from itkTransformParametersAdaptorBasePython import *
