...
class itkLabelObjectLine2(object):
    ...
    def SetLength(self, length: 'unsigned long long const') -> "void":
        """SetLength(itkLabelObjectLine2 self, unsigned long long const length)"""
        return _itkLabelObjectLinePython.itkLabelObjectLine2_SetLength(self, length)


    def GetLength(self) -> "unsigned long long const &":
        """GetLength(itkLabelObjectLine2 self) -> unsigned long long const &"""
...
class itkLabelObjectLine3(object):
    ...
    def SetLength(self, length: 'unsigned long long const') -> "void":
        """SetLength(itkLabelObjectLine3 self, unsigned long long const length)"""
        return _itkLabelObjectLinePython.itkLabelObjectLine3_SetLength(self, length)


    def GetLength(self) -> "unsigned long long const &":
        """GetLength(itkLabelObjectLine3 self) -> unsigned long long const &"""
