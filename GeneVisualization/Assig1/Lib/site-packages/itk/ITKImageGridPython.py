...
if version_info >= (3, 0, 0):
    new_instancemethod = lambda func, inst, cls: _ITKImageGridPython.SWIG_PyInstanceMethod_New(func)
else:
...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_ITKImageGridPython', [dirname(__file__)])
        except ImportError:
            import _ITKImageGridPython
            return _ITKImageGridPython
        if fp is not None:
            try:
                _mod = imp.load_module('_ITKImageGridPython', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _ITKImageGridPython = swig_import_helper()
...
from itkPadImageFilterBasePython import *
from itkPadImageFilterPython import *
from itkBSplineDownsampleImageFilterPython import *
from itkBSplineUpsampleImageFilterPython import *
from itkBinShrinkImageFilterPython import *
...
from itkCyclicShiftImageFilterPython import *
...
from itkZeroFluxNeumannPadImageFilterPython import *
