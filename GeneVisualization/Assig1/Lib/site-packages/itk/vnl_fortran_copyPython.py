...
class vnl_fortran_copyCF(object):
    """Proxy of C++ vnl_fortran_copyCF class."""
...
vnl_fortran_copyCF_swigregister = _vnl_fortran_copyPython.vnl_fortran_copyCF_swigregister
vnl_fortran_copyCF_swigregister(vnl_fortran_copyCF)
