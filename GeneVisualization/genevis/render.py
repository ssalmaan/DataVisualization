...
class RaycastRenderer(ABC):
    ...
    def __init__(self, tfunc: TransferFunction):
        self.volume = None
        self.image_size = 0
        self.image = np.zeros(0, dtype=np.int8)  #original code is int8
    ...
    def set_volume(self, volume):
        ...
        self.volume = volume
        self.gradient= GradientVolume(v)
        ...
        self.image = np.zeros(self.image_size * self.image_size * 4, dtype=np.int8)  # image_size x image_size x RGBA #original code is int8
