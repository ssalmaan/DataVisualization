...
if version_info >= (3, 0, 0):
    new_instancemethod = lambda func, inst, cls: _ITKImageFeaturePython.SWIG_PyInstanceMethod_New(func)
else:
...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_ITKImageFeaturePython', [dirname(__file__)])
        except ImportError:
            import _ITKImageFeaturePython
            return _ITKImageFeaturePython
        if fp is not None:
            try:
                _mod = imp.load_module('_ITKImageFeaturePython', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _ITKImageFeaturePython = swig_import_helper()
...
from itkHoughTransform2DCirclesImageFilterPython import *
...
from itkMaskFeaturePointSelectionFilterPython import *
...
from itkUnsharpMaskImageFilterPython import *
